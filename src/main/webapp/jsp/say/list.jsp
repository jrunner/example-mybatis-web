        ...
        <div class="col-md-9" role="main">
            <div>
                <div class="page-header">
                    <button type="button" class="btn btn-primary" onclick="toUpdate()">发表说说</button>
                </div>
...
<script>
    $(document).ready(function() {
        var url = "${pageContext.request.contextPath}/say/query";
    ...
    function del(id){
        var url = "${pageContext.request.contextPath}/say/del";
        $.ajax({type: "POST",url: url, cache: false, data: {id:id}, dataType: 'json',success: JCollBack });
    }

    function toUpdate(){
        var url = "${pageContext.request.contextPath}/jsp/say/update.jsp";
        window.location = url;
    }
